...
class TestStatsEdgeCases(unittest.TestCase):
    def test_wilson_crash_perfect_compliance(self):
        ...
        try:
            _, utl, _ = wilson_score_upper_tolerance(p_hat=1.0, n=20, n_eff=20, conf_level=0.95)
    ...
    def test_wilson_small_sample_perfect(self):
        # Case: n=5, p_hat=1.0
        _, utl, _ = wilson_score_upper_tolerance(p_hat=1.0, n=5, n_eff=5, conf_level=0.95)
    ...
    def test_wilson_small_sample_imperfect(self):
        ...
        # dist = 1.
        _, utl, _ = wilson_score_upper_tolerance(p_hat=0.9, n=10, n_eff=10, conf_level=0.95)
        # Should be > 0.9
